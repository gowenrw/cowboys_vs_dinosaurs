...
void loop(void) {
  ...
  testLines(GC9A01A_CYAN);
  delay(800);

  testFastLines(GC9A01A_RED, GC9A01A_BLUE);
  delay(800);

  testRects(GC9A01A_GREEN);
  delay(800);

  testFilledRects(GC9A01A_YELLOW, GC9A01A_MAGENTA);
  delay(800);

  testFilledCircles(10, GC9A01A_MAGENTA);
  delay(800);

  testCircles(10, GC9A01A_WHITE);
  delay(800);
